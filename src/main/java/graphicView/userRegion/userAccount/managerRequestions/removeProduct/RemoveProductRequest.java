...
//        Main.setMediaPlayer("01 In The Morning Light.mp3");
        ...
        Scene root = new Scene(FXMLLoader.load(RemoveProductRequest.class.getResource("/graphicView/userRegion/userAccount/managerRequestions/removeProduct/RemoveProductRequest.fxml")));
