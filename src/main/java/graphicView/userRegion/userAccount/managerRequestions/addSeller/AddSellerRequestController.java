...
public class AddSellerRequestController implements Initializable {
    ...
    public static void setCurrentRequestId(String currentRequestId) {
        AddSellerRequestController.currentRequestId = currentRequestId;
    }
    ...
    private ObservableList<RequestIds> getRequest() {
        ...
        for (RequestForSeller requestForSeller : RequestForSeller.getAllRequestsForSeller()) {
            requestIds.add(new RequestIds(requestForSeller.getRequestId()));
        }
        return requestIds;
    }
    ...
    public class RequestIds {
        ...
        public RequestIds(String requestId) {
            ...
            this.requestId.setOnMousePressed(actionEvent -> {
                AddSellerRequest.window.close();
                setCurrentRequestId(requestId);
                try {
                    AddSellerRequestInfo.display();
