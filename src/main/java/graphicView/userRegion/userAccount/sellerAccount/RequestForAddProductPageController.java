...
public class RequestForAddProductPageController {
    ...
    public void sendRequest() {
        ...
        if (!category.matches("\\w+")) {
            alertMessage.setText("Please enter a valid format of category!");
            return;
        }
        if (!productName.matches("\\w+")) {
            alertMessage.setText("Please enter a valid product name!");
            return;
        }
        if (!priceString.matches("\\d+")) {
            alertMessage.setText("Please enter a valid price!");
            return;
        }
        if (!explanationText.matches("\\w+")) {
            alertMessage.setText("Please enter a valid explanation text!");
            return;
        }
