...
//            }
//        }
        Date fin = new Date(120, 6, 23, 11, 27, 45);
    ...
    private static void reload() {
        Category.setAllCategories(new Json<Category>().getAllJson("src/server.main/resources/Categories", "category"));
        Product.setAllProducts(new Json<Product>().getAllJson("src/server.main/resources/Products", "product"));
        Manager.setAllManagers(new Json<Manager>().getAllJson("src/server.main/resources/Accounts/Managers", "manager"));
        Seller.setAllSeller(new Json<Seller>().getAllJson("src/server.main/resources/Accounts/Sellers", "seller"));
        Purchaser.setAllPurchaser(new Json<Purchaser>().getAllJson("src/server.main/resources/Accounts/Purchasers", "purchaser"));
        for (Purchaser purchaser : Purchaser.getAllPurchaser()) {
            purchaser.newCartAndSelectedSellerForProducts(purchaser);
        }
        Comment.setAllComments(new Json<Comment>().getAllJson("src/server.main/resources/Comments", "comment"));
        ...
        setProductCategory();
        ShopBankAccount.setAllShopBankAccount(new Json<ShopBankAccount>().getAllJson("src/server.main/resources/Bank Account", "bankAccount"));
        Auction.setAllAuctions(new Json<Auction>().getAllJson("src/server.main/resources/Auction", "auction"));
        setCategoryAuction();
    }
}