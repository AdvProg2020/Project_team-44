...
public class ManageProductsForSellerMenu extends Menu {
    ...
    private Menu getViewProductMenu() {
        return new Menu("View Product Menu", this) {
            ...
            @Override
            public void execute() {
                Seller seller = (Seller) LoginPageController.getLoggedInAccount();
                for (String product : SellerAccountController.processShowProducts(seller)) {
        ...
        return new Menu("Edit Product Menu", this) {
            ...
            public void execute() {
                ...
                try {
                    ...
                    System.out.println("your request for edit send to manager");
                    this.backInExecute();
