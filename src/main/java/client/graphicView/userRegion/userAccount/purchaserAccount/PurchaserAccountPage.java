...
public class PurchaserAccountPage {
    ...
    public static void display() throws IOException {
        ...
        Parent root = FXMLLoader.load(PurchaserAccountPage.class.getResource("/client/graphicView/userRegion/userAccount/purchaserAccount/PurchaserAccountPage.fxml"));
